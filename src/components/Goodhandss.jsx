...
function Goodhandss() {
  return (
    <div
      ...
      "
    >
      <div className="max-w-2xl px-4 sm:px-6 text-center">
        {/* Декоративная полоска */}
        <img
          src={Rectangle}
          alt="decorative line"
          className="mx-auto w-24 sm:w-40 h-1 mb-4 sm:mb-6"
        />
        ...
        {/* Параграф */}
        <p className="text-white text-center font-dm-sans text-base sm:text-xl font-normal leading-6 sm:leading-7 opacity-60 w-full sm:w-[435px] mx-auto">
          Torquatos nostros? quos dolores eos, qui dolorem ipsum per se texit, ne ferae quidem se repellere,
          idque instituit docere sic: omne animal, simul atque integre iudicante itaque aiunt hanc quasi
          involuta aperiri, altera occulta quaedam et voluptatem accusantium doloremque.
        </p>
        ...
        >
          Learn more
          <img src={Path} alt="Path" className="ml-2 w-4 sm:w-auto" />
        </button>
      </div>
    </div>
  );
